...
function donation_callback_wp() {
    ...
    if(!empty($_POST['stripeToken'])){
        ...
        $stripe = array(
          "secret_key"      => "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",
          "publishable_key" => "pk_live_51NmNDEDapmKLlBZINog3R48dfcnnf9gfQs4whFiLU0hZyfPRbj6tC3hy2vKZE0HbiqnCqkSeRJCmt7DAZXj7QkG700d25iRh7h"
        );   
        /*$stripe = array(
          "secret_key"      => "sk_test_51NmNDEDapmKLlBZId74hjCzq8q30ke7vXS4JsEzmYPOqLem46oZx4GQ7oS6BcU9GtlR2RpEqxN0KnuTaxxNdYjce00gAvetrRA",
          "publishable_key" => "pk_test_51NmNDEDapmKLlBZI1eK4oBBIz7NJD35uLnl3zjAqTaINXs9UKVM4eahMEgmWCCgyYJ3hgapE7emQ9rShZyUSqd9Q00tFlAoyja"
        );  */ 
    	...
    	if($select_payment_type == "monthly"){
    	    try { 
                ...
                $price = \Stripe\Price::create([ 
                    ...
                    'product_data' => ['name' => 'Donation - irousa'], 
                ]); 
            } catch (Exception $e) {  
...
function send_stripe_email($customerName, $customerEmail, $totalAmount){
                                            ...
                                            <tbody><tr>
                                              <td colspan="12">
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-bottom:1px solid #9f9f9f">
                                                  <tbody><tr>
                                                    <td align="center">
                                                    <a href="https://www.irousa.org/"><img src="https://www.irousa.org/wp-content/uploads/2023/08/adam-alani-logo-final-1024x369.png" width="128" style="margin-bottom:30px;" alt="IRO"></a>
                                                    </td>
                                                  </tr>
                                                </tbody></table>
                                              </td>
                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="padding-top:34px;">
                                                  <tbody><tr>
                                                    <td colspan="12">
                                                      ...
                                                      <p style="font-size: 15px;line-height: 23px;color: #000;margin-bottom: 26px;">If you need futher assistance, please contact us at <a href="mailto:info@irousa.org" style="color: #018fd7;">info@irousa.org</a>.</p>
                                                    </td>
                                                  </tr>
                                                </tbody></table>
                                              </td>
                                            ...
                                            <tr>
                                              <td colspan="12">
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="padding-bottom: 15px;padding-top: 0;">
                                                  <tbody><tr>
                                                    <td colspan="12">
                                                      <p style="margin:0;font-size: 12px;line-height: 23px;color: #000;">© 2023 International Rights Organization Copyright | All Right Reserved<br/><a style="margin:0;font-size: 12px;line-height: 23px;color: #000;" href="https://www.irousa.org/" style="color: #018fd7;">www.irousa.org</a></p>
                                                    </td>
                                                  </tr>
                                                </tbody></table>
                                              </td>
    ...
    $headers[] = "From: IRO <info@irousa.org>";
